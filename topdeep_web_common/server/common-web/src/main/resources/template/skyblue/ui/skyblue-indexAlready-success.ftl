    ...
    <div class="tabbar-panel" style="display: block;">
        <div class="header">
            <div class="header-container">
                ...
                <div class="hr">
					<i class="user-photo"></i><span>张希</span>
                </div>
            </div>
        </div>
	...
	<div class="tabbar-panel" style="display: none;">
		<div class="weui_tab_bd box-more">
			...
			<div class="weui_cells sub-form margin-spacing0">
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myContacts">
					...
					<div class="weui_cell_ft">2个</div>
				</a>
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myMsg">
					<div class="weui_cell_hd">
					...
					<div class="weui_cell_ft"><span class="msg-number">5</span></div>
				</a>
			</div>
			<div class="weui_cells sub-form">
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myBank">
					<div class="weui_cell_hd">
					...
					<div class="weui_cell_ft">2张</div>
				</a>
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myPwd">
					<div class="weui_cell_hd">
			...
			<div class="weui_cells sub-form">
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myRedpacket">
					<div class="weui_cell_hd">
					...
					<div class="weui_cell_ft">2个未使用</div>
				</a>
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myActivity">
					<div class="weui_cell_hd">
			...
			<div class="weui_cells sub-form">
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myTest">
					<div class="weui_cell_hd">
					...
					<div class="weui_cell_ft">稳健型</div>
				</a>
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myAbout">
					<div class="weui_cell_hd">
				...
				<a class="weui_cell" href="${base}/ui/skyblue.action?type=myQuestion">
					<div class="weui_cell_hd">
			...
			<div class="btn padding-spacing sub-placeholder-lg">
				<a href="${base}/ui/skyblue.action?type=index" class="weui_btn bg-blue">退出登录</a>
			</div>
		</div>
	</div>
