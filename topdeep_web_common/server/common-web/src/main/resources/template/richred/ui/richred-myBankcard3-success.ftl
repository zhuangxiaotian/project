...
<ul class="sub-form">
    <li class="login-list">
        ...
        <div class="sub-box">
            <div class="sub-input">
                <a href="${base}/ui/richred.action?type=myBankcard4">
    ...
    <li class="login-list">
        <label>手<i class="text-placeholder">a</i>机<i class="text-placeholder">a</i>号</label>
        <div class="sub-input">
            <input type="password" placeholder="请输入您在银行预留的手机号码" />
        </div>
    </li>
    <li class="login-list">
