<!-- Navigation -->
<nav class="navbar navbar-static-top sub-navbar" role="navigation">
        ...
        <div class="nav-common clearfix">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="${base}/static/skin/${res.skin}/images/logo.png" alt="玄谷">
                    统一样式管理平台
                </a>
            </div>
            <!-- /.navbar-header -->
            <ul class="nav navbar-top-links navbar-left nav-service sub-link">
                <li>
                    <ul>
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #fff;">
                                <span class="nav-select-l">服务号</span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu  sub-nav-list nav-list-l">
                                <li>
                ...
                <li>
                    <ul>
                        <li class="dropdown">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: #fff;">
                                <span class="nav-select-r">用户一</span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu sub-nav-list nav-list-r">
                                <li>
                                    <a href="javascript:void(0)">用户二</a>
                                </li>
                                <!--<li class="divider"></li>-->
                                <li><a href="javascript:void(0)">用户三</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
