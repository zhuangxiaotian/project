...
public class MembershipcardAction extends BaseAction {

	@TopdeepMethodAttribute(loginRequired = false)
	@RequestMapping(value = "membershipcard", method = {
		RequestMethod.GET
	})
	public String execute(SampleRequest req, Model model) throws Exception {
		...
		res.setSkin("membershipcard");
		res.setTitle(req.getType());
		String template = "/ui/membershipcard-" + req.getType() + "-success";
