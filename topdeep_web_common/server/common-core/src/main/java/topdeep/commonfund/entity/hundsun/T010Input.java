 ...
 * 可修改分红方式列表(T010)
 */
public class T010Input extends HundsunBaseInput implements Serializable {
	...
	/**
	 * 份额查询类型,1:：直销专户份额,2：查询直销公募基金份额其他：待补充
	 */
	...
	public void serializeToMap(Map<String, String> inputMap) {
		...
		inputMap.put("bonusmode", this.bonusmode);
