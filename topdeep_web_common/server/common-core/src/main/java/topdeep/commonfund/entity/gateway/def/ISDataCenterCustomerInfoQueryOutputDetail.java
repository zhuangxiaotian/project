 ...
 * 数据中心客户信息查询功能输出明细参数
 */
public class ISDataCenterCustomerInfoQueryOutputDetail extends Object implements Serializable {
	 ...
	 * 修改来源,
	 */
	public void setModifyfrom(String value)
	 {
		this.modifyfrom = value;
	}
