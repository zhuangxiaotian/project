 ...
 */
public class C004OutputRisklist extends Object implements Serializable {
	...
	private List<C004OutputQitem> qitem = new ArrayList<C004OutputQitem>();
	...
	public List<C004OutputQitem> getQitem() {
		return this.qitem;
	}
