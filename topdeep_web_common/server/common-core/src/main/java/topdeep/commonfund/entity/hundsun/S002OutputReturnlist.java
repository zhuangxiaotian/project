...
/**
 * 当日交易申请查询(S002)功能输出明细参数
 */
public class S002OutputReturnlist extends Object implements Serializable {
	...
	/**
	 * 银行返回错误原因,交易申请查询77和交易申请查询91接口需要升级到9B
	 */
	private String cperrormsg = "";
	
	/**
	 * 活动代码,促销活动的代码，用于区分参与活动的份额
	 */
