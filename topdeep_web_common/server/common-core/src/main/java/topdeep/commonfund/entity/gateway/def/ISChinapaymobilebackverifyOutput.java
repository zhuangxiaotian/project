 ...
 * 银联通开户返回信息验证功能输出参数
 */
public class ISChinapaymobilebackverifyOutput extends topdeep.commonfund.entity.gateway.def.ISBaseOutput implements Serializable {
	...
	public ISChinapaymobilebackverifyOutput() {
