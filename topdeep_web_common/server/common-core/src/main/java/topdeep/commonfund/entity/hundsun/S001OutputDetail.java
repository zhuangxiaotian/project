 ...
 */
public class S001OutputDetail extends Object implements Serializable {
	 ...
	 * 当前份额余额,
	 */
	@PropertyAttribute(Name="当前份额余额", Type="F", Length=16, DecimalLength=2, NotNull=true)
	 ...
	 * 冻结份额余额,
	 */
	@PropertyAttribute(Name="冻结份额余额", Type="F", Length=16, DecimalLength=2, NotNull=true)
	 ...
	 * 分红方式,取字典“分红方式”，"0":红利再投资,"1":现金红利
	 */
	@PropertyAttribute(Name="分红方式", Type="C", Length=1, DecimalLength=0, NotNull=true)
	 ...
	 * 单位净值,
	 */
	@PropertyAttribute(Name="单位净值", Type="F", Length=7, DecimalLength=4, NotNull=true)
	 ...
	 * 份额类别,取字典“份额类别”，A:前收费,B:后收费,C:水平收费
	 */
	@PropertyAttribute(Name="份额类别", Type="C", Length=1, DecimalLength=0, NotNull=true)
	 ...
	 * 交易冻结份额,
	 */
	@PropertyAttribute(Name="交易冻结份额", Type="F", Length=16, DecimalLength=2, NotNull=true)
	 ...
	 * 可用份额余额,
	 */
	@PropertyAttribute(Name="可用份额余额", Type="F", Length=16, DecimalLength=2, NotNull=true)
	 ...
	 * 基金账号,
	 */
	@PropertyAttribute(Name="基金账号", Type="S", Length=0, DecimalLength=0, NotNull=true)
	 ...
	 * 基金代码,
	 */
	@PropertyAttribute(Name="基金代码", Type="S", Length=0, DecimalLength=0, NotNull=true)
	 ...
	 * 超级现金宝可赎回份额,超级现金宝可用于赎回业务操作的份额
	 */
	@PropertyAttribute(Name="超级现金宝可赎回份额", Type="S", Length=0, DecimalLength=0, NotNull=true)
	 ...
	 * 超级现金宝可转换份额,超级现金宝可用于转换业务操作的份额（用于适应超级现金宝业务）
	 */
	@PropertyAttribute(Name="超级现金宝可转换份额", Type="S", Length=0, DecimalLength=0, NotNull=true)
	 ...
	 * 浮动盈亏,
	 */
	@PropertyAttribute(Name="浮动盈亏", Type="S", Length=0, DecimalLength=0, NotNull=true)
	 ...
	 * 认购未结果确认金额,
	 */
	@PropertyAttribute(Name="认购未结果确认金额", Type="S", Length=0, DecimalLength=0, NotNull=true)
	 ...
	 * 结算币种,"156":人民币,"840":美元
	 */
	@PropertyAttribute(Name="结算币种", Type="S", Length=3, DecimalLength=0, NotNull=true)
	 ...
	 * 销售类型,0:直销, 1:代销
	 */
	@PropertyAttribute(Name="销售类型", Type="C", Length=1, DecimalLength=0, NotNull=false)
	 ...
	 * 银行卡号,屏蔽四位
	 */
	@PropertyAttribute(Name="银行卡号", Type="S", Length=28, DecimalLength=0, NotNull=false)
	 ...
	 * 银行名称,银行名称
	 */
	@PropertyAttribute(Name="银行名称", Type="S", Length=28, DecimalLength=0, NotNull=false)
	 ...
	 * 基金名称,
	 */
	@PropertyAttribute(Name="基金名称", Type="S", Length=20, DecimalLength=0, NotNull=false)
	 ...
	 * 基金市值,
	 */
	@PropertyAttribute(Name="基金市值", Type="F", Length=16, DecimalLength=4, NotNull=false)
	 ...
	 * 未付收益,
	 */
	@PropertyAttribute(Name="未付收益", Type="F", Length=16, DecimalLength=2, NotNull=false)
	 ...
	 * 销售商编号,销售商名称取字典“EQAgencyName”
	 */
	@PropertyAttribute(Name="销售商编号", Type="C", Length=10, DecimalLength=0, NotNull=false)
	 ...
	 * 净值日期,yyyy-MM-dd格式字符串
	 */
	@PropertyAttribute(Name="净值日期", Type="C", Length=10, DecimalLength=0, NotNull=false)
	 ...
	 * 到期可用余额,超短期理财产品赎回、赎回转购时的可赎回余额
	 */
	@PropertyAttribute(Name="到期可用余额", Type="F", Length=16, DecimalLength=2, NotNull=false)
	 ...
	 * 快速赎回可用份额,如果快速赎回没有比例限制则返回值与可用份额余额相同
	 */
	@PropertyAttribute(Name="快速赎回可用份额", Type="S", Length=16, DecimalLength=0, NotNull=false)
	 ...
	 * 份额基金类别,
	 */
	@PropertyAttribute(Name="份额基金类别", Type="S", Length=16, DecimalLength=0, NotNull=false)
	 ...
	 * 份额分类,静态份额的分类，普通份额返回空，组合理财份额返回‘0’
	 */
	@PropertyAttribute(Name="份额分类", Type="S", Length=1, DecimalLength=0, NotNull=false)
	 ...
	 * 当日收益,仅支持直销的货币基金，并升级00服务到H0
	 */
	@PropertyAttribute(Name="当日收益", Type="S", Length=16, DecimalLength=0, NotNull=false)
	 ...
	 * 累计收益,仅支持直销的货币基金，并升级00服务到H0
	 */
	@PropertyAttribute(Name="累计收益", Type="S", Length=16, DecimalLength=0, NotNull=false)
	 ...
	 * 基金状态,
	 */
	@PropertyAttribute(Name="基金状态", Type="S", Length=1, DecimalLength=0, NotNull=false)
	 ...
	 * 银行编号,
	 */
	@PropertyAttribute(Name="银行编号", Type="S", Length=3, DecimalLength=0, NotNull=false)
	 ...
	 * 网点号,数据来源为DC,querttype为null或者是1时生效
	 */
	@PropertyAttribute(Name="网点号", Type="S", Length=0, DecimalLength=0, NotNull=false)
	 ...
	 * TA代码,数据来源为DC,querttype为null或者是1时生效
	 */
	@PropertyAttribute(Name="TA代码", Type="S", Length=0, DecimalLength=0, NotNull=false)
	 ...
	 * 资金方式,
	 */
	@PropertyAttribute(Name="资金方式", Type="S", Length=1, DecimalLength=0, NotNull=false)
	 ...
	 * 集合基金标志,集合基金标志，“1”为集合基金，“0”非集合基金
	 */
	@PropertyAttribute(Name="集合基金标志", Type="S", Length=1, DecimalLength=0, NotNull=false)
