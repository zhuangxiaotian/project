...
/**
 * 可签解约银行卡列表(I001)功能输出明细参数
 */
public class I001OutputDetail extends Object implements Serializable {
	 ...
	 * 是否有定投协议,1:有定投协议, 0:无
	 */
	public String getValuavgr() {
		return this.valuavgr;
	}
	
	/**
	 * 是否有定投协议,1:有定投协议, 0:无
	 */
	public void setValuavgr(String value)
	 {
		this.valuavgr = value;
	}
